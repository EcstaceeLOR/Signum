...
[**Play Signum on Vercel**](https://signum-delta.vercel.app/) · [View the public manifest](https://signum-delta.vercel.app/game.manifest.json)
...
- Live game: <https://signum-delta.vercel.app/>
- Public manifest: <https://signum-delta.vercel.app/game.manifest.json>
- GitHub Pages mirror: <https://ecstaceelor.github.io/Signum/>
- Static deploy: Vercel builds merged `main` commits using the pinned Vite configuration in `vercel.json`.
