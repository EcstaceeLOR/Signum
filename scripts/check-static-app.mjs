...
assert.ok(
  javascriptGzipBytes <= 118 * 1024,
  `JavaScript gzip budget exceeded: ${formatKilobytes(javascriptGzipBytes)} > 118 kB.`,
)
assert.ok(
...
assert.ok(
  totalGzipBytes <= 127 * 1024,
  `Combined gzip budget exceeded: ${formatKilobytes(totalGzipBytes)} > 127 kB.`,
)
